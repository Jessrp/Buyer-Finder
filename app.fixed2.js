...
window.showBrowserNotification = showBrowserNotification;
  ...
  // Init browser notifications permission
  ...
  if (navNotifications)
    navNotifications.addEventListener("click", () => {
      ...
      if (
        window.Notifications && typeof window.Notifications.loadNotifications === "function") { window.Notifications.loadNotifications(); }
    });
