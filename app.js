...
// Get supabase from window (set by supabase.js)
...
async function initApp() {
    ...
    // Get supabase from window (it's set by supabase.js)
    ...
    if (!supabase || typeof supabase.from !== 'function') {
        console.error('Supabase is not properly configured! Check your supabase.js file.');
        console.log('App will run in limited mode without database.');
        showAuthScreen();
        return;
    }
