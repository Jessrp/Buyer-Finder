...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // UI filter values used by posts.js: "selling" | "request"
  ...
  function setActivePostType(type) {
    // Normalize any accidental "requesting" into the UI's "request"
    if (type === "requesting") type = "request";
  ...
  if (navRequests) navRequests.addEventListener("click", () => setActivePostType("request"));
