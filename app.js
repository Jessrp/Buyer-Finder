...
function setupEventListeners() {
    ...
    document.getElementById('signInGoogleAuth')?.addEventListener('click', signInWithGoogle);
    document.getElementById('signInEmailAuth')?.addEventListener('click', showEmailSignIn);
