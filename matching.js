...
(function () {
  // Simple, schema-correct matching for BuyerFinder:
  // - Matches "selling" <-> "requesting"
  // - Scores by keyword overlap (title weighted)
  // - No imaginary fields like category/price_min/keywords required
  ...
  function scorePosts(a, b) {
    ...
    // Title overlap matters more (better quality matches)
