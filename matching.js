...
(function () {
  ...
  const MATCH_THRESHOLD = 10; // lowered so real posts actually match // keyword/price score threshold
  ...
  async function insertMatchRow(buyPost, sellPost, score) {
    ...
    if (BF_MATCH_DEBUG) console.log("BF Matching: inserting match row…");
