...
import { initMatchListener } from './matches.js';
...
(function () {
  ...
  async function savePost() {
    ...
    // ===== ADDITION #6: Trigger automatic matching =====
    await findMatchesForPost(payload);
    // ================================================
  }
  ...
  detailCloseBtn.onclick = () => { detailOverlay.classList.remove("active"); detailPanel.classList.remove("active"); };
  detailOverlay.onclick = detailCloseBtn.onclick;
  ...
  // ===== ADDITION #5: INIT MATCH LISTENER =====
  if (window.currentUser) initMatchListener();
  // ============================================
