...
(function () {
  ...
  function isBFPlus() {
    // Use global helper from app.js if available, otherwise check profile directly
  ...
  // Count how many posts the current user already has
  ...
  // Count how many messages the current user has sent
  ...
  async function savePost() {
    ...
    // Create matches after saving (best-effort)
  ...
  // ─── OPEN POST BY ID (used by Matches tab) ──────────────────────
