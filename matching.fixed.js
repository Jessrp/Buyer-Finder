...
(function () {
  // BuyerFinder matching engine:
  // - Matches requesting <-> selling (your current schema)
  // - Scores by keyword overlap (title weighted heavier)
  ...
  function scorePosts(a, b) {
    // Safety: never match a user's own posts (even if upstream filtering fails)
    ...
    // Tune: title overlap matters more than description overlap
