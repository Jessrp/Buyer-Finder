...
(() => {
  ...
  // Optional shortcut button in the user card
  btnSigninShortcut?.addEventListener("click", () => {
    // Default to Google (fastest), user can still use email button up top.
    btnGoogle?.click?.();
  });
  ...
  // Settings > Premium button uses a different id, but should do the same thing
